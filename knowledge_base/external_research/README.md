...
QCS8550 on-device AI Runtime / model deployment / quantization / heterogeneous
performance project. Real-ESRGAN and QuickSRNet are the current workloads, so
some resources are still SR-focused. It is intentionally small: do not dump
every related GitHub project here.
...
- For the current Real-ESRGAN workload, read `super_resolution/realesrgan`.
...
- For Android/QNN Runtime integration references, read `qnn_android`.
