...
| Demo Mode current live ROI video | `20260723_demo_mode_direct_yuv_current_20s`, 20s MP4, wide preview display with QNN/SR timing |
| Demo Mode current timing | `20260723_demo_mode_direct_yuv_current_timing`, app e2e p50/p95/p99 `8 / 9 / 10ms` |
